...
class Car implements Cloneable {
	...
	protected Object clone() throws CloneNotSupportedException {
		...
		Car tempcar = new Car();
		tempcar.company = this.company;
		tempcar.number = this.number;
		tempcar.wheel = new Wheel();
		tempcar.wheel.diameter = this.wheel.diameter;
		tempcar.wheel.width = this.wheel.width;
		return tempcar;
	}
